...
class ArtistsViewModel(
    ...
    private val _effects = MutableSharedFlow<ArtistsEffect>()
    val effects: SharedFlow<ArtistsEffect> = _effects.asSharedFlow()
        ...
        when (action) {
            ...
            is ArtistsAction.OnArtistClick -> {
                viewModelScope.launch {
                    _effects.emit(ArtistsEffect.NavigateToArtist(action.artistId))
                }
            }
        }
    }
        ...
        viewModelScope.launch {
            ...
            repository.refreshData()
                .onFailure { e ->
                    ...
                    _effects.emit(ArtistsEffect.ShowError(e.message ?: "Failed to refresh"))
                }
                .onSuccess {
